...
public class BlocksEvidence {
    ...
    public static final writing_book WRITING_BOOK = new writing_book(AbstractBlock.Settings.create());
    ...
    public static void RegisterBlocks(){
        ...
        addItemsToGroup(GROUP_EVIDENCE, SALT_ITEM, WRITING_BOOK_ITEM);
    }
