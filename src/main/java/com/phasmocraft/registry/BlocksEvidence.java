...
import com.phasmocraft.block.evidence.SaltBlock;
...
public class BlocksEvidence {
    public static final SaltBlock SALT = new SaltBlock(FabricBlockSettings.create());
    ...
    public static final BlockEntityType<uvPrintsBlockEntity> UV_PRINTS_BLOCK_ENTITY = Registry.register(
        Registries.BLOCK_ENTITY_TYPE,
        new Identifier(MODID, "uv_prints_be"),
        FabricBlockEntityTypeBuilder.create(uvPrintsBlockEntity::new, UV_PRINTS_BLOCK).build()
    );
